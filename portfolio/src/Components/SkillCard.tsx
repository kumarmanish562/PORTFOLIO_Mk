...
// SkillBadge function to render each skill as a badge with icon and label
const SkillBadge=(skills:[])=>{
    // Map through skills array and render a badge for each skill
...
const SkillCard =(props:any)=>{
    // Render skill card with title and skill badges
...
// Exporting SkillCard component as default
