// FloatingInput component definition
const FloatingInput = (props: any) => {

    // Render input or textarea based on id, with floating label and error display
    return <div> 
        <div className="relative">
            {/* Render input for all except 'message', otherwise render textarea */}
            {props.id != "message" ? 
                <input 
                    type="text" 
                    id={props.id} 
...
// Exporting FloatingInput component as default
